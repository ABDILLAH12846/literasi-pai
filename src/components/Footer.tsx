      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-8 sm:py-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-2">
              ...
              <span className="text-base font-bold text-gray-900">QuranLens Review</span>
            </Link>
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-gray-500">
              Platform ulasan dan rekomendasi buku Pendidikan Agama Islam untuk menunjang pembelajaran Anda.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-100 pt-6 text-center">
          <p className="text-xs text-gray-400">
            © {currentYear} QuranLens Review — Platform Ulasan Buku Pendidikan Agama Islam
          </p>
        </div>
      </div>
    </footer>
